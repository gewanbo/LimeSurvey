                ...
                <div class="col-lg-12">
                    <div class="form  text-right">
                        ...
                        <?php $form=$this->beginWidget('CActiveForm', array(
                            'action' => Yii::app()->createUrl('admin/survey/sa/listresources/surveyid/'.$surveyid),
                            'method' => 'get',
                                'htmlOptions'=>array(
                                    'class'=>'form-inline',
                                ),
                            ...
                            <a href="<?php echo Yii::app()->createUrl('admin/survey/sa/listresources/surveyid/'.$surveyid);?>" class="btn btn-warning"><?php eT('Reset');?></a>
...
//                                'header' => gT('Preview'),
//                                'name' => 'thumb_link',
//                                'value'=>'CHtml::image($data->thumb_link)',
//                            ),
                            array(
                                'header' => gT("Frontend link"),
                                'name' => 'frontend_link',
                                'value'=>'$data->frontend_link',
                            ),
                            array(
                                'header' => gT('Image width'),
                                'name' => 'image_width',
                                'value'=>'$data->image_width'
                            ),
                            array(
                                'header' => gT('Image height'),
                                'name' => 'image_height',
